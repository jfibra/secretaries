...
import FilerobotImageEditor from "{{ asset('plugins/filerobot-image/packages/filerobot-image-editor/src') }}";
import config from "{{ asset('plugins/filerobot-image/public/demo-config.js') }}";
